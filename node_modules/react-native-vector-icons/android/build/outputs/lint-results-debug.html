...
<link rel="stylesheet" type="text/css" href="lint-results-debug_files/hololike.css" />
...
Check performed at Wed Aug 31 16:08:04 CST 2016.<br/>
1 errors and 4 warnings found:<br/><br/>
<table class="overview">
<tr><td></td><td class="categoryColumn"><a href="#Correctness">Correctness</a>
</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><img border="0" align="top" src="lint-results-debug_files/lint-error.png" alt="Error" />
<a href="#InvalidPackage">InvalidPackage: Package not included in Android</a>
</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><img border="0" align="top" src="lint-results-debug_files/lint-warning.png" alt="Warning" />
<a href="#OldTargetApi">OldTargetApi: Target SDK attribute is not targeting latest version</a>
</td></tr>
<tr>
<td class="countColumn">2</td><td class="issueColumn"><img border="0" align="top" src="lint-results-debug_files/lint-warning.png" alt="Warning" />
...
<tr><td></td><td class="categoryColumn"><a href="#MissingIssues">Disabled Checks (15)</a>
</td></tr></table>
<br/>
...
<span class="location"><a href="../../../../../../../../.gradle/caches/modules-2/files-2.1/com.squareup.okio/okio/1.8.0/5ea7af56cc7c567ed9856d99efb30740e9b17ff/okio-1.8.0.jar">../../../../../../../../.gradle/caches/modules-2/files-2.1/com.squareup.okio/okio/1.8.0/5ea7af56cc7c567ed9856d99efb30740e9b17ff/okio-1.8.0.jar</a></span>: <span class="message">Invalid package reference in library; not included in Android: <code>java.nio.file</code>. Referenced from <code>okio.Okio</code>.</span><br />
</div>
...
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:19</span>: <span class="message">Not targeting the latest versions of Android; compatibility modes apply. Consider testing and updating this version. Consult the android.os.Build.VERSION_CODES javadoc for details.</span><br /><pre class="errorlines">
<span class="lineno">  16</span> 
<span class="lineno">  17</span>   defaultConfig {
<span class="lineno">  18</span>     minSdkVersion 16
<span class="lineno">  19</span>     <span class="errorspan">targetSdkVersion 22</span>
<span class="lineno">  20</span>     versionCode 1
<span class="lineno">  21</span>     versionName "1.0"
</pre>
</div>
<div class="metadata">Note: This issue has an associated quickfix operation in Android Studio/IntelliJ&nbsp;<img alt="Fix" border="0" align="top" src="lint-results-debug_files/lint-run.png" />
<br>
Priority: 6 / 10<br/>
Category: Correctness</div>
...
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:7</span>: <span class="message">A newer version of com.android.tools.build:gradle than 1.1.3 is available: 2.1.0</span><br /><pre class="errorlines">
<span class="lineno">   4</span>   }
<span class="lineno">   5</span> 
<span class="lineno">   6</span>   dependencies {
<span class="lineno">   7</span>     <span class="errorspan">classpath 'com.android.tools.build:gradle:1.1.3'</span>
<span class="lineno">   8</span>   }
<span class="lineno">   9</span> }
</pre>
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:15</span>: <span class="message">Old buildToolsVersion 23.0.1; recommended version is 23.0.3 or later</span><br /><pre class="errorlines">
<span class="lineno">  12</span> 
<span class="lineno">  13</span> android {
<span class="lineno">  14</span>   compileSdkVersion 23
<span class="lineno">  15</span>   <span class="errorspan">buildToolsVersion "23.0.1"</span>
<span class="lineno">  16</span> 
<span class="lineno">  17</span>   defaultConfig {
</pre>
</div>
...
<span class="lineno">  33</span>   <span class="errorspan">compile "com.facebook.react:react-native:+"</span>
...
<div class="metadata">Note: This issue has an associated quickfix operation in Eclipse/ADT&nbsp;<img alt="Fix" border="0" align="top" src="lint-results-debug_files/lint-run.png" />
<br>
Disabled By: Default<br/>
Priority: 2 / 10<br/>
Category: Correctness</div>
...
<div class="metadata">Note: This issue has an associated quickfix operation in Android Studio/IntelliJ & Eclipse/ADT&nbsp;<img alt="Fix" border="0" align="top" src="lint-results-debug_files/lint-run.png" />
<br>
Disabled By: Default<br/>
Priority: 5 / 10<br/>
